...
def get_data(id):
    ...
    for n in nodes:
        ...
        if tags.has_key('amenity')  or tags.has_key('leisure') or tags.has_key('tourism') or  tags.has_key('shop'):
            ...
            node['properties']['visible'] = n.attrib['visible']
            node['properties']['version'] = int(n.attrib['version'])
    ...
    for w in ways:
        ...
        if tags.has_key('amenity')  or tags.has_key('leisure') or tags.has_key('tourism') or  tags.has_key('shop'):
            ...
            way['properties']['visible'] = w.attrib['visible']
            way['properties']['version'] = int(w.attrib['version'])
    ...
    for r in relations:
        ...
        if tags.has_key('amenity')  or tags.has_key('leisure') or tags.has_key('tourism') or  tags.has_key('shop'):
            ...
            relation['properties']['visible'] = r.attrib['visible']
            relation['properties']['version'] = int(r.attrib['visible'])
